    ...
    <main class="bg-white-300 flex-1 p-3 overflow-hidden">
        <div class="flex flex-col">
            ...
            <div class="px-6 py-2 border-b border-light-grey">
                <div class="font-bold text-xl">Create Posts</div>
            </div>
        </div>
                ...
                <div class="w-full px-6 py-8">
                    <form method="post" action="/dashboard/posts" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="title_blog" id="title_blog" class="focus:border-green-500 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none @error('title_blog') border-2 border-red-700 @enderror"  placeholder="" required value="{{ old('title_blog') }}" autofocus>
                            @error('title')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" id="slug" class="focus:border-green-500 appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none @error('slug') border-2 border-red-700 @enderror" placeholder="" required readonly value="{{ old('slug') }}">
                            @error('slug')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <img class="img-preview w-1/2 mt-3">
                            @error('image')
                            <p class="text-red-500 text-xs italic">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="block flex md:flex items-center justify-between">
                            <button type="submit" class="align-middle bg-grey-dark hover:bg-gray-600 text-center px-4 py-2 text-white text-sm font-semibold rounded-lg inline-block shadow-lg">Create Post</button>
